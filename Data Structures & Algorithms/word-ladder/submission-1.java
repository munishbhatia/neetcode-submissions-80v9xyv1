class Solution {
    public int ladderLength(String beginWord, String endWord, List<String> wordList) {
        ...
        final Map<String, List<String>> adjList = createGraphFromWildcardWords(wordList);
    ...
    private Map<String, List<String>> createGraphFromWildcardWords(List<String> wordList) {
        final Map<String, List<String>> graph = new HashMap<>();
        ...
        while(!q.isEmpty()) {
            ...
            for(int i = 0; i < qsize; ++i) {
                ...
                for(int j = 0; j < curr.length(); ++j) {
                    ...
                    for(String n : adjList.getOrDefault(pattern, new ArrayList<>())) {
