    ...
    public int coinChange(int[] coins, int amount) {
        ...
        for(int i=0; i<coins.length; ++i) {
            ...
            for(int j=1; j<=amount; ++j) {
                ...
                minCoinsCurr[j] = (minCoinsCurr[j - coinValue] == -1) ? 
                                    minCoinsPrev[j] //Don't pick the current value coin since it's leading to a non-solution (minCoinsCurr[j - coinValue] == -1)
