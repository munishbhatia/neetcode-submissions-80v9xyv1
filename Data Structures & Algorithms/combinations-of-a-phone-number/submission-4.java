class Solution {
    public List<String> letterCombinations(String digits) {
        ...
        letterCombinationsBacktrack(digits, 0, len, digitCharMap, new StringBuilder(), response);

        return response;
    }

    private void letterCombinationsBacktrack(String digits, int index, int len, Map<Character, List<String>> digitCharMap, StringBuilder current, List<String> response) {
        ...
        for(String s : digitCharMap.get(digits.charAt(index))) {
            ...
            letterCombinationsBacktrack(digits, index+1, len, digitCharMap, current, response); //Recurse
