    ...
    public int leastInterval(char[] tasks, int n) {
        ...
        while(!primary.isEmpty()) {
            ...
            while(!backup.isEmpty()) {
                primary.offer(backup.poll()); //By using an ArrayDeque instead of PQ for the backup queue, backup.poll() becomes O(N) instead of O(NlogN)!! Although overall complexity of the loop still stays O(NlogN) due to primary.offer() operation being logN * N
            }
